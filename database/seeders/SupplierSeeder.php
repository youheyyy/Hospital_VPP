...
class SupplierSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('suppliers')->insert([
            ['supplier_id' => 1, 'supplier_name' => 'Văn phòng phẩm - Nhà sách Thanh Vân', 'supplier_code' => 'SUP001', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['supplier_id' => 2, 'supplier_name' => 'Vật tư tiêu hao - Nhà sách Quốc Nam', 'supplier_code' => 'SUP002', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ...
            ['supplier_id' => 6, 'supplier_name' => 'NƯỚC UỐNG ĐÓNG BÌNH - CỬA HÀNG GIA KIỆT', 'supplier_code' => 'SUP006', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ...
            ['supplier_id' => 9, 'supplier_name' => 'CN CÔNG TY CP THƯƠNG MẠI BÁCH HÓA XANH- CH BÁCH HÓA XANH ĐỒNG THÁP SỐ 49', 'supplier_code' => 'SUP009', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ]);
    }
}
