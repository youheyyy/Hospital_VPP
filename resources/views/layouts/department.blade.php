        ...
        <header
            ...
            <div class="flex items-center gap-8">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('images/logo-tmmc.png') }}" alt="HSS Logo" class="h-14 w-auto object-contain">
                    <div class="flex items-center gap-1.5 mt-2">
                        <div class="h-[3px] w-4 bg-[#00a8e8] rounded-full"></div>
                        <span class="text-[12px] font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap">Quản Lý Văn Phòng Phẩm</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="px-2 mb-4">
                        <div class="flex flex-col items-center justify-center gap-3 w-full pt-2">
                            ...
                            <div class="flex items-center justify-center gap-1.5 w-full">
                                ...
                                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] whitespace-nowrap">Quản Lý Văn Phẩm</span>
                                <div class="h-[2px] w-4 bg-[#00a8e8] rounded-full"></div>
                            </div>
                        </div>
                    </div>
