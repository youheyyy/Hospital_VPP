...
<head>
    ...
    <title>Dashboard Quản trị VPP</title>
    ...
    <style type="text/tailwindcss">
        ...
        .slim-sidebar {
            @apply w-64 bg-white border-r border-slate-100 flex flex-col py-8 px-4 gap-4 transition-all duration-300;
        }
        .sidebar-item {
...
<body class="flex h-screen overflow-hidden">
    <aside class="w-64 bg-white border-r border-slate-100 flex flex-col flex-shrink-0 transition-all duration-300">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a class="sidebar-item" href="{{ route('admin.consolidated') }}">
        ...
        <div class="p-10 max-w-[1600px] mx-auto">
            ...
            <div class="bento-card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div
                        class="flex items-center gap-1.5 px-3 py-1 bg-mint-50 text-mint-600 rounded-full text-[10px] font-black uppercase tracking-widest border border-mint-100">
