...
<div class="p-8">
    ...
    <div class="mb-8 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-500 text-sm">Xem và chỉnh sửa ngân sách cho các khoa phòng</p>
        </div>
    ...
    <div class="mb-6 bg-white p-4 rounded-lg border border-gray-100">
        <form method="GET" action="{{ route('admin.budgets.index') }}" class="flex items-center gap-4">
                    ...
                    @forelse($departments as $dept)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                ...
                                <form action="{{ route('admin.budgets.destroy', $budget) }}" method="POST" class="inline" onsubmit="return confirm('Bạn có chắc muốn xóa ngân sách này?')">
                                    @csrf
                                    @method('DELETE')
...
function recalculateBudget(budgetId) {
    if (confirm('Bạn có chắc muốn tính lại ngân sách từ các đơn hàng hiện có?')) {
        fetch(`/admin/budgets/${budgetId}/recalculate`, {
            method: 'POST',
            headers: {
